...
void menu_2_click(int a) {
  ...
  switch (a) {
    case IRK_1:
    case IRK4_1: z = 1; break;
    case IRK_7:
    case IRK4_7: z = -1; break;
    case IRK_3:
    case IRK4_3: z = 0.5; break;
    case IRK_9:
    case IRK4_9: z = -0.5; break;

    case IRK_2:
    case IRK4_2: y = -1; break;
    case IRK_4:
    case IRK4_4: x = -1; break;
    case IRK_6:
    case IRK4_6: x = 1; break;
    case IRK_8:
    case IRK4_8:
      y = 1;
      break;
...
void restartLCD() {
  ...
  if (lcd_kind == KIND_LCD2004) {
    ...
    // LCD.init(lcd_sda, lcd_scl, 0x27, 20, 4);
