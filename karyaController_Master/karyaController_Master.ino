...
int strToPin(File f1, char u = '\n') {
  ...
  if (s2 == "IO0") return 0;
  if (s2 == "IO4") return 4;
  if (s2 == "IO16") return 16;
  if (s2 == "IO17") return 17;
  if (s2 == "IO5") return 5;
  if (s2 == "IO18") return 18;
  if (s2 == "IO19") return 19;
  if (s2 == "IO21") return 21;
  if (s2 == "IO3") return 3;
  if (s2 == "IO1") return 1;
  if (s2 == "IO22") return 22;
  if (s2 == "IO23") return 23;
  if (s2 == "IO13") return 13;
  if (s2 == "IO12") return 12;
  if (s2 == "IO14") return 14;
  if (s2 == "IO27") return 27;
  if (s2 == "IO26") return 26;
  if (s2 == "IO25") return 25;
  if (s2 == "IO33") return 33;
  if (s2 == "IO32") return 32;
  if (s2 == "TX2") return TX2;
  if (s2 == "RX2") return RX2;
  if (s2 == "TX") return TX;
  if (s2 == "RX") return RX;
  if (s2 == "A0") return A0;
  if (s2 == "?") return 255;
...
void saveconfigs() {
  ...
  f1.println(thc_ofs);
  f1.print("home=");
  f1.print(ax_home[0], 2);
  f1.print(",");
  f1.print(ax_home[1], 2);
  f1.print(",");
  f1.println(ax_home[2], 2);
  f1.print("home_ofs=");
  f1.print(axisofs[0], 2);
  f1.print(",");
  f1.print(axisofs[1], 2);
  f1.print(",");
  ...
  switch (type) {
    ...
    case WStype_CONNECTED:
      {  // if a new websocket connection is established
        ...
        // Serial.print(String("[%d] Connected from %d.%d.%d.%d url: %s\n"), fi(num), fi(ip[0]), fi(ip[1]), fi(ip[2]), fi(ip[3]), payload);
